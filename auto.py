...
class execution(object):
    ...
    def setup(self):
        ...
        if isinstance(_xyz, str):
            ...
            self.atoms = Atoms([Atom(a[0], (a[1], a[2], a[3])) for a in _xyz])
    ...
    def spacegroup(self):
        ...
        sg = spglib.get_symmetry_dataset(spglib.refine_cell(self.atoms))[
            "international"
        ]
    ...
    def calc(self, force_id=None, functional=None):
        ...
        self.print(
            "Calculation with {} log and Input: {}.".format(_fn, self.inputFileName)
        )
    ...
    def optim(self, force_id=None, functional=None):
        ...
        self.print(
            "Optimization with {} log and Input: {}.".format(_fn, self.inputFileName)
        )
